...
.tc-logo {
  ...
  font-size: 24pt; font-weight: 700; color: #b34a2a;
  letter-spacing: 1px; line-height: 1; flex: 0 0 auto;
}
.tc-letterhead { flex: 1; text-align: center; line-height: 1.2; }
.tc-company { font-family: 'Georgia', serif; font-size: 13pt; font-weight: 700; }
.tc-addr { font-size: 7.5pt; }
.tc-contact { font-size: 7.5pt; }
.tc-title {
  text-align: center; font-weight: 700; font-size: 10pt;
  border-top: 1pt solid #000; border-bottom: 1pt solid #000;
  padding: 1mm 0; margin: 1.5mm 0 1.5mm 0; letter-spacing: 0.5px;
}
.tc-meta-row {
...
table.tc-grid th, table.tc-grid td {
  ...
  vertical-align: top; font-size: 7.8pt; line-height: 1.2;
}
...
.tc-section {
  ...
  border-top: 0.5pt solid #000; margin-top: 1.5mm;
}
.tc-section span.tc-sub-rule { font-weight: 400; font-size: 7pt; }
